...
// می‌سازد که مرجعِ **ترجمه‌ی دستی** است.
//
// ⚠️ ترجمه‌ی فارسی **دستی** انجام می‌شود، نه با LLM. کلیدِ OpenRouter فقط برای خودِ محصول
// است و کارِ توسعه با آن انجام نمی‌شود (قاعده‌ی صریحِ مالک، ۱۴۰۵/۰۵/۲۴).
//
