...
/* ⚠️ و بارِ دوم، همان تله از سمتِ **نقلِ‌قول** (v3.95.0): الگوی قبلی
...
console.log('\n▶ ۱۱) دو لنگرِ ریپلای: دُمِ فال و سؤالِ کاربر');
{
  ...
  ok(/const askedId = askedIdIn \|\| ctx\.message\?\.message_id \|\| 0;/.test(hc),
    'گفتگو شناسه‌ی پیامِ خودِ کاربر را برمی‌دارد (و از v3.95.0 لنگرِ تزریقیِ دکمه‌ی سؤال را هم می‌پذیرد)');
...
/* ═══ ۲۰) سؤالِ پیشنهادی، پایانِ مکالمه، نیت و دکمه‌ی منو (v3.95.0) ══════════
 *
