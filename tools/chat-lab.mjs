...
const PROMPT_VARIANTS = {
   ...
   * بلوکِ قدیمیِ «خطِ آخر» بود که v3.114.0 بازنویسی‌اش کرد، پس هر دو دیگر فقط بلد
   * بودند با «هیچ تغییری نداد» اجرا را بکُشند. مقایسه‌ی v3.114.0 با خطِ پایه‌ی **ثبت‌شده**
