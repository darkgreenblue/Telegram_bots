...
//
// **هر دو شکلِ بلند و کوتاه لازم است.** شکلِ بلند همان برچسبِ واقعیِ خودِ ربات است و
// گزینه‌های نوشن از روی آن ساخته شده‌اند؛ شکلِ کوتاه برای وقتی است که مالک بعداً برچسب‌ها
// را کوتاه کند. جاافتادنِ یکی هیچ خطایی نمی‌دهد: ردیف بی‌صدا به `personal` می‌افتد و فقط
// وقتی معلوم می‌شود که ویدیوی «شغل» جوابِ عمومی بدهد. `tools/check-tarot-video.mjs`
// هر برچسبِ `TOPICS_V3` را از همین مسیر عبور می‌دهد تا این حالت ممکن نماند.
// هر دو املای «سؤال/سوال» هم هست چون هر دو در نوشن تایپ می‌شوند؛ ناشناخته/خالی → `personal`.
export const TOPIC_MAP = {
  'سؤال شخصی خودم': 'personal',
  'سؤال شخصی': 'personal',
  'سوال شخصی': 'personal',
  'بله و خیر قطعی': 'yesno',
  'بله و خیر': 'yesno',
  'عشق و رابطه': 'love',
  'حس طرف مقابل': 'feel',
  'بازگشت اکس': 'exback',
  ...
  'فال کراش': 'crush',
  'کراش': 'crush',
  'بهم خیانت کرده؟': 'commit',
  'بهم خیانت کرده': 'commit',
  'تعهد یا خیانت': 'commit',        // نامِ قبلی — ردیف‌های قدیمیِ نوشن نباید بی‌صدا بیفتند
  'خیانت': 'commit',
  'فال ازدواج': 'marriage',
  'ازدواج': 'marriage',
  'کی به آدمم می‌رسم؟': 'soulmate',
  'کی به آدمم می‌رسم': 'soulmate',
  'کار و پول': 'career',
  'شغل و مسیر کاری': 'career',      // نامِ قبلی
  'شغل': 'career',
  'درس و کنکور': 'study',
  'کنکور': 'study',
  'اپلای و مهاجرت': 'apply',
  'مهاجرت': 'apply',
  // ⬇ موضوع‌های بازنشسته‌ی منو. چیدمانشان هنوز resolve می‌شود (RETIRED_TOPICS در
  // spreads.js)، پس ردیفِ قدیمیِ نوشن با این برچسب‌ها هنوز ویدیوی درست می‌سازد.
  'پول و درآمد بیشتر': 'money',
  'پول': 'money',
  'دوراهی': 'choice',
};
