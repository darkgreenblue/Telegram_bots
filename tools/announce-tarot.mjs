...
// خطِ آخر. لحنِ فوریت درست است چون کارت شانس **روزانه** است و این پیام شب می‌رود.
export const CTA = 'کارت شانس امروزت رو از دست نده و فرصت کمی براش مونده.';
...
export const balanceLines = (coins, paid) => [
  ...
  `موجودی ذخایر الماس: ${coins} الماس`,
].join('\n');
