...
LOCALE = {
    ...
    "support": {
        ...
        "body": (
            "🆘 *الدعم*\n\n"
            "اضغط الزر بالأسفل واكتب رسالتك بإيجاز ووضوح؛ سنرد عليك سريعاً.\n\n"
            "ستفتح لك رسالة جاهزة تحتوي رمز المتابعة. أبقِ الرمز واكتب رسالتك تحته.\n\n"
            "رمز المتابعة الخاص بك (اضغط للنسخ):\n`{code}`"
        ),
    },
