...
/* فهرست عمداً فقط فارسی است: `CHAT_LOCALES = ['fa']` و واژه‌ی حدسیِ زبانی که هنوز
 * کاربر ندارد، کدِ مرده است (بند ۹/۰). بازکردنِ هر زبان یک ردیف این‌جا اضافه می‌کند. */
const MONEY_WORD = /(تومان|ریال|الماس|ستاره|استارز)/g;
