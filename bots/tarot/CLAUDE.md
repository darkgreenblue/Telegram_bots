...
- رفرال: `/start ref_<id>`؛ گیرنده فوراً ۱۰k، معرف بعد از **اولین فال deliver شده‌ی** گیرنده (فال رایگانِ با هدیه هم شمرده می‌شود). دکمه‌ی «📤 دعوت دوستان» در کیبورد اصلی: لینک اختصاصی قابل‌کپی + دکمه‌ی switch_inline_query.
