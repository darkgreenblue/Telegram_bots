...
- قیمت فال‌ها (spreads.js): daily رایگان (روزی یک‌بار، تقویم تهران) | yesno ۱۵k | three ۳۰k | money/inner ۴۰k | love/career/choice ۵۰k | celtic ۹۰k.
- رفرال: `/start ref_<id>`؛ گیرنده فوراً ۱۰k، معرف بعد از **اولین فال deliver شده‌ی** گیرنده.
- کارت: همان کارت voice2text. کد ۱۰۰٪ = تأیید خودکار بدون رسید. `/newcode CODE PERCENT DAYS [USER_ID]`، `/stats` (شامل قیف کانورژن: readings به تفکیک status).
