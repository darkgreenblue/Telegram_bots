...
/* ⏳ اوپن‌روتر برای `gemini-2.5-flash` تاریخِ حذف گذاشته (`expiration_date: 2026-10-20` در
 * `/api/v1/models`، خوانده‌شده ۱۴۰۵/۰۷/۰۴). جانشینِ هم‌خانواده‌اش (نسخه‌ی بالاتر، شنوا و
 * بینا) این است؛ تصمیمِ مالک: «فقط یک مدل بالاتر از خودش». */
export const GEMINI3_FLASH  = 'google/gemini-3-flash-preview';
