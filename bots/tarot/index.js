...
// 🚚 لحظه‌ی لانچِ UX v2 برای همه (unix). مرزِ «کاربرِ قبل از لانچ» در پنجره‌ی یک‌باره‌ی
// مهاجرتِ کیبورد است — جزئیات و دلیلش داخلِ خودِ `ensureMenu`. عددِ ثابت است نه محاسبه‌ی
// زنده، چون باید بعد از هر ری‌استارت هم دقیقاً همان مرز بماند.
const KB_V2_EPOCH = 1787252801;
