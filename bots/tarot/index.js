...
// 3.78.0: 🔙 **رول‌بکِ افزایشِ قیمتِ v3.75.0** (تصمیمِ صریحِ مالک، بر پایه‌ی تحلیلِ
//         `analytics/tarot/reports/2026-09-10-revenue-drop.md`). سه بسته به ۳۰k/۶۰k/۱۵۰k
//         برگشتند و دو بسته‌ی «افسانه‌ای»/«جاودان» به‌همراهِ آزمایشِ نمایششان بازنشسته
//         شدند. کلیدهایشان زنده می‌مانند (ردیفِ پرداختِ باز + دکمه‌ی کهنه، بند ۲ج/۵ و ۶).
