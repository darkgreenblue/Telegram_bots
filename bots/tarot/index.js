...
// (سبز/آبی از قبل، قرمز رویِ «افسانه‌ای»). Bot API رنگِ چهارمی ندارد، پس «جاودان»
// (v3.77.0، تصمیمِ صریحِ مالک) هم همان قرمز را می‌گیرد — دو بسته عمداً هم‌رنگ‌اند و
// تمایزشان از خودِ متنِ دکمه می‌آید (نامِ بسته + ایموجیِ 👑ِ خودِ «جاودان»)، نه رنگ.
