...
export const SAFE_BOX = { x: 200, y: 480, w: 680, h: 260 };
...
// ارتفاعِ کمِ ردیفِ بالا فقط زیبایی‌شناسی نیست: فاصله‌ی کفِ این کارت‌ها تا باندِ خطرِ باکس
// همان مقدارِ حرکتِ عمودیِ آزادی است که مسیر برای **گرد کردنِ گوشه** دارد. با ۱۷۵ فقط
// ۱۶ پیکسل بود، یعنی کارت مجبور بود سرِ گوشه کاملاً بایستد و بعد راه بیفتد (حسِ رباتی).
export const TOP_ROW = { y: 250, cardH: 152, gap: 26 };
...
export const FOCUS_CARD = { cy: 1006, h: 408 };
...
export const TITLE_BOX = { x: 70, y: 250, w: 940, h: 152 };
