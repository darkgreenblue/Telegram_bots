...
export const SAFE_BOX = { x: 200, y: 500, w: 680, h: 310 };
...
export const TOP_ROW = { y: 265, cardH: 195, gap: 26 };
export const FOCUS_CARD = { cy: 1060, h: 480 };
export const CAPTION_BOX = { x: 70, y: 1320, w: 940, h: 200 };
export const VERDICT_BOX = { x: 70, y: 860, w: 940, h: 660 };
...
export const TITLE_BOX = { x: 70, y: 265, w: 940, h: 195 };
