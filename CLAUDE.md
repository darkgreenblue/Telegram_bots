...
| `bots/secretary` | pm2: `secretary` | منشیِ شخصیِ صوتی: ویس→نیت→ثبت خودکار در Google Calendar (جلسه) و TickTick (کار/خواندنی/فکر، لیست «منشی») + حافظه‌ی منشی | 🧪 تست شخصی — تک‌کاربره (فقط ادمین)؛ بدون یادآوریِ داخلی؛ گوگل=Service Account، تیک‌تیک=OAuth | `bots/secretary/CLAUDE.md` |
