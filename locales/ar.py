...
LOCALE = {
    ...
    "voice_too_long":  "رؤياك طويلةٌ جدًّا 🌌 احكِها بإيجازٍ أكثر (أقلّ من ١٠ دقائق) كي لا يضيع منها شيء.",
    ...
    "need_subscription_prefix": "لِفَتحِ التعبيرِ الكامل، تحتاج إلى مفتاحِ هذه البوّابة. 🗝️",
    "paywall_offer": (
        "خُذ بيدي وسافِر معي إلى أعماقِ رؤاك الليلية:\n\n"
        "🎁 رفقةُ شهرٍ واحد 👈 أوفر بنسبة ٥٠٪\n"
        "💎 رفقةُ ٣ أشهر 👈 أوفر بنسبة ٧٠٪\n"
        "👇"
    ),
