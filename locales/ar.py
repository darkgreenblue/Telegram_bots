...
LOCALE = {
    ...
    "personas": {
        "orthodox": {
            ...
            "greet": "الآن عرفتُك أكثر يا صديقي 🕌",
            "invite": (
                "أغمِض عينيك وأخبرني برؤياك، لأقرأها في ضوء الآيات والنشانات — "
                "*رسالة صوتية* 🎙 (أو اكتبها إن شئت)."
            ),
            "image_caption": "رؤياك تجلَّت في مرآة النور 🎨✨",
            "error": "انقطع الاتصال لحظةً 🌫️ حاول مرّة أخرى؛ نصيبك محفوظ عندي.",
        },
        "folk": {
            "prompt": (
            ...
            "greet": "الآن عرفتُك أكثر يا صديقي 🌙",
            "invite": (
                "احكِ لي رؤياك، لأكشف سرّها على طريقة المعبِّرين القدامى — "
                "*رسالة صوتية* 🎙 (أو اكتبها إن شئت)."
            ),
            "image_caption": "رؤياك صارت نقشًا من الخيال 🎨✨",
            "error": "انقطع الخيط لحظةً 🌫️ حاول مرّة أخرى؛ نصيبك محفوظ عندي.",
        },
        "modern": {
            "prompt": (
            ...
            "greet": "الآن عرفتُك أكثر يا صديقي 🧠",
            "invite": (
                "احكِ لي رؤياك، لنغوص معًا في أعماق النفس وحكمة القدماء — "
                "*رسالة صوتية* 🎙 (أو اكتبها إن شئت)."
            ),
            "image_caption": "رؤياك صارت صورةً للّاوعي 🎨✨",
            "error": "اضطرب الاتصال لحظةً 🌫️ حاول مرّة أخرى؛ نصيبك محفوظ عندي.",
        },
    },

    "voice_too_short": "الرسالة كانت قصيرة شوي 🌙 احكِ رؤياك بشكل أوسع قليلًا لأتمكن من قراءتها.",
    "voice_too_long":  "رؤياك طويلة جدًّا 🌌 احكِها بإيجاز أكثر (أقل من ٥ دقائق) كي لا يضيع منها شيء.",
    "text_too_short":  "كتبتَ قليلًا ✍️ أضِف لي أكثر قليلًا لأكشف سرّها.",

    "confirm_voice": "سمعتُ رؤياك 🌙 هل آخذ هذه لأعبّرها؟",
    "confirm_text":  "قرأتُ رؤياك 🌙 هل آخذ هذه لأعبّرها؟",
    "btn_confirm":   "✅ نعم، عبّرها",
    "btn_cancel":    "🔁 أريد أن أرسلها مجددًا",
    "cancelled":     "تمام 🌙 متى كنتَ جاهزًا، احكِ لي رؤياك من جديد.",

    "daily_limit": (
        "الليلة قرأتُ رؤياك وسِرنا معًا في عالَم الرؤى 🌙\n"
        "أعبّر رؤيا واحدة كل ليلة؛ غدًا الليل أنتظرك من جديد ✨"
    ),
    "image_failed": "ضاعت صورة رؤياك في الضباب هذه المرة 🌫️ لكن تعبيرها هنا:",
    ...
    "narration_patience": [
        "اصبر شوية يا صديقي… 🍇",
        "في الصبر يتحوّل الحِصرم عسلًا ✨",
        "الرؤى العميقة تبوح بسرّها ببطء… ابقَ معي قليلًا 🌙",
        "اقتربنا… الصبر مفتاح كل كنز خفي 🗝️",
    ],

    "catchphrase": "ضع يدك في يدي وكن رفيقي في عالَم الرؤى 🌙",
    "pay_success_tmpl": (
        "تم الدفع وأمسكتُ بيدك يا صديقي! 🤝✨\n"
        "من الآن، لمدة *{days} يومًا*، نسير جنبًا إلى جنب في عالَم الرؤى 🌙"
    ),
    "referral_reward": (
        "مَن جئتَ به إلى عالَم الرؤى أمسك بيدي وصار رفيقي 🎁\n"
        "أهديتُك 7 أيام رِفقة مجانًا؛ شكرًا لك ✨"
    ),
    "sub_active_tmpl": (
        "أنت رفيقي في عالَم الرؤى 🌙\n"
        "لمدة *{days} يومًا* إضافية نسير جنبًا إلى جنب ✨"
    ),
    "sub_inactive_head": "لم تنضم إليّ بعد 🌙",
    "need_subscription_prefix": "لفتح التعبير الكامل، تحتاج إلى مفتاح هذه البوابة. 🗝️",
    "paywall_offer": (
        "خُذ بيدي وسافِر معي إلى أعماق رؤاك الليلية:\n\n"
        "🎁 رفقة شهر واحد 👈 أوفر بنسبة ٥٠٪\n"
        "💎 رفقة ٣ أشهر 👈 أوفر بنسبة ٧٠٪\n"
        "👇"
    ),
    "paywall_intro": "كل رحلة تحتاج زادًا؛ اختر واحدًا:",

    "invite_text_tmpl": (
        "كل مَن تجلبه إلى *عالَم الرؤى* يمنحك 7 أيام رِفقة هدية مع أول اشتراك له 🎁\n\n"
        "رابطك:\n{link}"
    ),
    "new_dream_greet": "ليلة أخرى ورؤيا أتشوّق لسماعها! 🌙",
    ...
    "processing_busy": "لحظة يا صديقي، ما زلت مع رؤياك السابقة… 🌙",
}
