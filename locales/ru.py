...
LOCALE = {
    ...
    "voice_too_long":  "Твой сон слишком долог 🌌 Расскажи его чуть короче (меньше 10 минут), чтобы ничего не потерять.",
    ...
    "need_subscription_prefix": "Чтобы открыть полное толкование, тебе нужен ключ от этих врат. 🗝️",
    "paywall_offer": (
        "Возьми меня за руку и отправься со мной в глубины твоих ночных снов:\n\n"
