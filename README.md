...
> 🧩 **پروژه‌ی جدید در ریپوی جدا؟** [`PLATFORM.md`](PLATFORM.md) قراردادِ زیرساختِ مشترک است (سرور، کلیدها، دیپلوی، پایش، بکاپ) با ورک‌فلوهای آماده‌ی کپی — همان فایل را در ریشه‌ی ریپوی جدید بگذار.
